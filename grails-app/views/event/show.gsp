	...
	<body>
		...
		<div id="show-event" class="content scaffold-show" role="main">
			...
			<ol class="property-list event">
				...
				<g:if test="${eventInstance?.speakers}">
				<li class="fieldcontain">
					<span id="speakers-label" class="property-label"><g:message code="event.speakers.label" default="Speakers" /></span>
					
						<g:each in="${eventInstance.speakers}" var="s">
